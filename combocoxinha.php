    ...
    <div class="novoMenu">
        ...
        <div class="container">
            ...
            <div class="navbar2">
                ...
                <div class="logo">
                    <img src="assets/img/logo (1).png" alt="DESPERTARTEC" width="140px">
                </div>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                ...
                <img src="assets/img/combo2.jpg" alt="" id="produtoImg">
            </a>
                        </div>
                        

                        <div class="col-2">
                            <h2>Combo de coxinha</h2>
                            <h3>Compre Agora</h3>
                            <h4>R$57,00 </h4>
                            <form action="" method="post">
                                ...
                                <button class="btn-adicionar" onclick="adicionarAoCarrinho('Kibe',7.00)">Adicionar ao Carrinho</button>
