...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/img/risoles_de_milho_queijo_thumb02.webp" alt="" id="produtoImg">
                        ...
                        <div class="col-2">
                            ...
                            <form action="" method="post">
                                ...
                                <button class="btn-adicionar" onclick="adicionarAoCarrinho('Risole',6.00)">Adicionar ao Carrinho</button>

                            </form>

                            <h3>Descrição:</h3>
                            <p>Risole muito saboroso!</p>
                        </div>
