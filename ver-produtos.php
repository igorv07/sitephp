...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/img/coxinha2.jpg" alt="" id="produtoImg">
                        ...
                        <div class="col-2">
                            ...
                            <form action="" method="post">
                                ...
                                <button class="btn-adicionar" onclick="adicionarAoCarrinho('Coxinha',7.00)">Adicionar ao Carrinho</button>

                            </form>

                            <h3>Descrição:</h3>
                            <p>Coxinha de frango muito saborosa!</p>
                        </div>
